    ...
    <div className="home-landing-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p>
            Descubre nuestra colección de instrumentos musicales de la más alta
            calidad. Desde guitarras clásicas hasta equipos profesionales de
            audio.
          </p>
          <div className="hero-actions">
            ...
            <Button kind="secondary" size="lg" href="/contacto">
              Conoce Más
            </Button>
          </div>
        </div>
        ...
        <Grid>
          <Column lg={16}>
            <h2 className="section-title">
              ¿Por qué elegir El Mundo Guitarras?
            </h2>
          </Column>
          ...
          <Column lg={5} md={4} sm={4}>
            <Tile className="feature-tile">
              ...
              <h3>Experiencia</h3>
              <p>
                Más de 20 años ofreciendo instrumentos musicales de excelencia.
              </p>
            </Tile>
          </Column>
          <Column lg={6} md={8} sm={4}>
            ...
            <Tile className="feature-tile">
              ...
              <h3>Variedad</h3>
              <p>
                Amplio catálogo con guitarras, accesorios y equipos de audio.
              </p>
            </Tile>
          </Column>
        </Grid>
        ...
        <Grid>
          <Column lg={10} md={6} sm={4}>
            <div className="cta-content">
              ...
              <p>
                Explora nuestra colección completa y encuentra el instrumento
                que llevará tu música al siguiente nivel.
              </p>
              <Button
                kind="primary"
                size="lg"
